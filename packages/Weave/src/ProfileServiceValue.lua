...
function ProfileServiceValue<T>(valueName: string, profileServiceKey: string)
	if RunService:IsClient() then
	...
	local self = setmetatable({
		...
		_initialValue = profileServiceValue,
		_profileServiceKey = profileServiceKey,
		_dataHandler = DataHandler,
		_name = valueName,
		_playerValue = WeavePlayerValue(`profileServiceValue_{valueName}`, profileServiceValue),
		_troves = {},
	}, CLASS_METATABLE)
